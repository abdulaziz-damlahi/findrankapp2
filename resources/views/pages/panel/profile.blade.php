                                        ...
                                        <div class="card-block">
                                            <div class="block-content block-content-full">
                                                <div><span class="tableStyle">Kelime Takibi</span> <span
                                                        class="tableStyle pull-right"><b>249</b> / 250</span></div>
                                                ...
                                                <div><span class="tableStyle">Site Ekleme</span> <span
                                                        class="tableStyle pull-right"><b>1</b> / 25</span></div>
                                                <div class="progress-bar-border" style="margin-bottom:3px">
                                                    <div class="progress progress-mini" style="margin-bottom:0;">
                                                        <div class="progress-bar progress-bar-success"
                                                             role="progressbar"
                                                ...
                                                <div><span class="tableStyle">Rakip Ekleme</span> <span
                                                        class="tableStyle pull-right"><b>5</b> / 30</span></div>
                                                <div class="progress-bar-border" style="margin-bottom:3px">
                                                    <div class="progress progress-mini" style="margin-bottom:0;">
                                                        <div class="progress-bar progress-bar-success"
                                                             role="progressbar"
                                                ...
                                                <div><span class="tableStyle">Sıra Sorgulama</span> <span
                                                        class="tableStyle pull-right"><b>0</b> / 500</span></div>
                                                <div class="progress-bar-border" style="margin-bottom:3px">
                                                    <div class="progress progress-mini" style="margin-bottom:0;">
                                                        <div class="progress-bar progress-bar-success"
                                                             role="progressbar"
                                                ...
                                                <div class="tableStyle">
                                                    ...
                                                    <small>Yeni kelime takibinde, manuel sıra güncellemesinde ve sıra
                                                        bulucuda yapacağınız sorgular.</small>
                                                </div>
                                                <hr>

                                                <div><span class="tableStyle">Kelime Önerisi</span> <span
                                                        class="tableStyle pull-right"><b>0</b> / 250</span></div>
                                                <div class="progress-bar-border" style="margin-bottom:3px">
                                                    <div class="progress progress-mini" style="margin-bottom:0;">
                                                        <div class="progress-bar progress-bar-success"
                                                             role="progressbar"
                                                ...
                                                <div class="tableStyle">
                                                    <small>Anahtar kelime aracında günlük sorgulayabileceğiniz farklı
                                                        kelime
                                                        sayısı.</small>
                                                </div>
                                            </div>
