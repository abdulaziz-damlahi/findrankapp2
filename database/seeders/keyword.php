...
class keyword extends Seeder
{
    ...
    public function run()
    {
        DB::table('keywords')->insert([
            ...
            ['name' => 'facebook 6', 'device' => 'Masaüstü', 'country' => 'AR', 'language' => 'english','different' => 0, 'city' => 'Roque', 'rank' => '4',  'website_id' => '2', 'user_id' => '2','created_at' => Carbon::now()->format('Y-m-d H:i:s')],
        ]);
    }
}
